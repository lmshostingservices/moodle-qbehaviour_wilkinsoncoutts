 ...
 *
 * @module    qbehaviour_wilkinsoncoutts/submission_confirmation
...
const TEMPLATES = {
    submissionConfirmation: 'qbehaviour_wilkinsoncoutts/submission_confirmation',
};
...
const registerEventListeners = (unAnsweredQuestions) => {
    ...
    if (submitAction) {
        ...
        submitAction.closest(SELECTOR.attemptSubmitForm).addEventListener('submit', e => e.preventDefault());
